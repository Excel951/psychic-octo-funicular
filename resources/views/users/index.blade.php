                            ...
                            <tr>
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        <button class="hover:text-primary" type="button" onclick="event.preventDefault(); window.location='{{ route('users.edit', $user) }}'">
                                        ...
                                        <button class="hover:text-primary" type="button" onclick="event.preventDefault(); window.location='{{ route('users.permissions', $user) }}'">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                                    d="M7 15q1.25 0 2.125-.875T10 12q0-1.25-.875-2.125T7 9q-1.25 0-2.125.875T4 12q0 1.25.875 2.125T7 15m0 3q-2.5 0-4.25-1.75T1 12q0-2.5 1.75-4.25T7 6q2.025 0 3.538 1.15T12.65 10h8.375L23 11.975l-3.5 4L17 14l-2 2l-2-2h-.35q-.625 1.8-2.175 2.9T7 18" />
                                            </svg>
                                        </button>
                                    </div>
                                </td>
